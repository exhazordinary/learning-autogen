...
class ResearchTask(db.Model):
    ...
    # Relationships
    messages = db.relationship('AgentMessage', backref='task', lazy='dynamic', cascade='all, delete-orphan')
    metrics = db.relationship('TaskMetrics', backref='task', uselist=False, cascade='all, delete-orphan')
